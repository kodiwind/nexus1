...
class Button(CompareMixin, xbmcgui.ControlButton):
    """
    Button(label, focusTexture=None, noFocusTexture=None, textOffsetX=CONTROL_TEXT_OFFSET_X, textOffsetY=CONTROL_TEXT_OFFSET_Y, alignment=4, font=None, textColor=None, disabledColor=None, angle=0, AthenaColor=None, focusedColor=None)
    ...
    :param angle: angle of control. (``+`` rotates CCW, ``-`` rotates CW)
    :type angle: int
    :param AthenaColor: hex color code of button's label's Athena. (e.g. ``'0xFF000000'``)
    :type AthenaColor: str
...
class RadioButton(CompareMixin, xbmcgui.ControlRadioButton):
    """
    RadioButton(label, focusTexture=None, noFocusTexture=None, textOffsetX=None, textOffsetY=None, _alignment=None, font=None, textColor=None, disabledColor=None, angle=None, AthenaColor=None, focusedColor=None, focusOnTexture=None, noFocusOnTexture=None, focusOffTexture=None, noFocusOffTexture=None)
    ...
    :param angle: angle of control. (+ rotates CCW, - rotates CW)
    :type angle: int
    :param AthenaColor: hexstring -- color of radio button's label's Athena. (e.g. '0xFF000000')
    :type AthenaColor: str
